...
export default function CalendarListPage() {
  ...
  const handleCreate = async () => {
    ...
    router.push(`/gantt/${id}?view=calendar`);
  };
  ...
  return (
    <div style={{ flex: 1, background: "var(--background)", color: "var(--foreground)" }}>
      {/* Modern Header */}
      <header
        style={{
          padding: "20px 40px",
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
            <div>
              ...
              <p style={{ margin: "4px 0 0", fontSize: 14, color: "var(--text-muted)", fontWeight: 400 }}>
                Project planning with calendar views
              </p>
            </div>
          </div>
          <button
        ...
        >
          ...
          >
            <div className="edit-modal-header">
              <h2 style={{ margin: 0, fontSize: 18, fontWeight: 600, letterSpacing: "-0.01em" }}>Create New Calendar</h2>
              <button
      ...
      <main style={{ padding: "32px 40px", maxWidth: 1400, margin: "0 auto" }}>
        {charts.length === 0 ? (
          <div style={{ textAlign: "center", padding: "120px 20px", color: "var(--text-muted)" }}>
            ...
            <h3 style={{ fontSize: 18, marginBottom: 8, fontWeight: 600, color: "var(--foreground)" }}>No calendars yet</h3>
          ...
          >
            {charts.map((c) => (
              <div
                ...
                onClick={() => router.push(`/gantt/${c.id}?view=calendar`)}
                onMouseEnter={(e) => {
